# Konzipieren einer Arbeit {#konzipieren}
...
| (Abgabetermin, Bearbeitungsfrist, eigene Planung) \vspace{-6mm}                    |                
+----------------------------------------------------------------------+
| * Wieviel Zeit werde ich für die einzelnen Phasen benötigen,         |
| bzw. wieviel darf ich mir erlauben?  \vspace{-6mm}                                   |         
+----------------------------------------------------------------------+
| * Wieviel Geld steht mir zur Verfügung, z. B. für Anschaffung von    | 
| Literatur, Kopien, Reisen, Software, Internet-Zugang usw.?  \vspace{-6mm}           |
+----------------------------------------------------------------------+
| * Welche Infrastruktur steht zur Verfügung, mit welchen              |
| Beschränkungen? (z. B. PC-Benutzerräume – Ausstattung, Auslastung?   |
| Bibliotheken – Öffnungszeiten, Urlaubssperren, Entleihfristen?)  \vspace{-6mm}       |
+----------------------------------------------------------------------+
...
### Thematik erschließen {#thematik-erschliessen}
...
Mit der globalen Vernetzung hat sich heute eine völlig neue Dimension für Studierende und Wissenschafter geöffnet: Relativ einfach, mit wenig Kosten und geringem Zeitaufwand können Sie sich weltweit z. B. über aktuelle Projekte informieren (Recherche im Internet, Besuch der Homepage des jeweiligen Wissenschaftlers, Instituts etc.) oder eine konkrete Anfrage starten (siehe Kapitel \@ref(recherchieren-im-internet): [Recherchieren im Internet]). 

Table: **(\#tab:enquiry) Social Inquiry**

+----------------------------------------------------------------------------------------------------------------------------------+
| * Wen kann ich aus meinem Bekanntenkreis zur Thematik fragen? (Betreuerin, Kollegin, fachfremde Personen,...)  \vspace{-6mm}                    |           
+----------------------------------------------------------------------------------------------------------------------------------+
| * Wen könnte ich außerhalb meines Bekanntenkreises fragen, anschreiben, interviewen?  \vspace{-6mm}                                             |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Personen haben sich zu meiner Problematik bereits profiliert?   \vspace{-6mm}                                                          | 
+----------------------------------------------------------------------------------------------------------------------------------+
| * Wer vertritt (im wissenschaftlichen Diskurs, in einer aktuellen Kontroverse) welche Position?  \vspace{-6mm}                                  |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Gibt es Meinungsführer/innen?   \vspace{-6mm}                                                                                                 |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Arbeits- und Forschungsgruppen arbeiten an meinem Thema?  \vspace{-6mm}                                                                |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Institution (Institut, Labor, Forschungseinrichtung) könnte ich besuchen (evt. virtuell über die Homepage im Internet)?  \vspace{-6mm}  |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Wie könnte ich kompetente Personen motivieren, für mich ihre kostbare Zeit zu opfern?  \vspace{-6mm}                                          |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Gibt es dazu eine gute (passende) Gelegenheit (Konferenz, Vortrag an meiner Hochschule etc.)?                                  |
+----------------------------------------------------------------------------------------------------------------------------------+

Auch wenn es heute (technisch) relativ einfach ist, mit den Akteurinnen der Wissenschaft in Kontakt zu treten, so bedeutet das nicht automatisch, dass Sie auch eine Antwort auf Ihre Frage(n) bekommen: Namhafte Leute (Wissenschafterinnen, Journalistinnen) sind viel beschäftigt und Sie müssen sich schon einen guten Grund einfallen lassen, wenn Ihre Anfrage nicht sang- und klanglos in den Weiten des Cyberspace verschwinden soll (siehe Kapitel \@ref(kooperieren): [Kooperieren]). 
...
Überlegen Sie sich schon bei dieser ersten Recherche ein System, mit dem Sie gefundene Literatur, E-Mail- und Internet-Adressen usw. so ordnen und aufbewahren, dass Sie später bei der systematischen Materialsammlung darauf zurückgreifen können (siehe Abschnitt \@ref(material-ordnen): [Material ordnen]).
...
+----------------------------------------------------------------------------------------------------------------------------------+
| * Wie viele Literaturhinweise habe ich bei der ersten Suche gefunden? \vspace{-6mm}                                                           |           
+----------------------------------------------------------------------------------------------------------------------------------+
| * Ist die Literatur für mich in der verfügbaren Zeitspanne zugänglich? \vspace{-6mm}                                                           |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Wird das Thema in der neuesten Literatur behandelt, gibt es eine aktuelle Diskussion dazu? \vspace{-6mm}                                     | 
+----------------------------------------------------------------------------------------------------------------------------------+
| * Was sind die wichtigsten Standpunkte, Theorien, Beteiligten in dieser Diskussion? \vspace{-6mm}                                              |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Aspekte werden unbefriedigend behandelt, zu wenig beachtet, fehlen überhaupt? \vspace{-6mm}                                           |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Was fordert Kritik oder Neugier heraus? \vspace{-6mm}                                                                                        |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Grundlagen und Voraussetzungen habe ich (bzw. fehlen mir), um das Thema zu bearbeiten? \vspace{-6mm}                                  |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Frage würde ich gern lösen? Welche kann ich lösen? \vspace{-6mm}                                                                      |
+----------------------------------------------------------------------------------------------------------------------------------+
...
| (Beschreibung des „state of the art“)  \vspace{-6mm}                                                                                            |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Was ist mein Erkenntnisinteresse, meine Motivation für diese Arbeit?  \vspace{-6mm}                                                           |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welches (theoretische, praktische, empirische, soziale, politische,...) Problem ist der Ausgangspunkt meiner Arbeit?  \vspace{-6mm}           | 
+----------------------------------------------------------------------------------------------------------------------------------+
| * Zu welchem Ziel (Ergebnis) soll meine Arbeit führen?  \vspace{-6mm}                                                                           |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Fragen will ich in meiner Arbeit behandeln (Thema)?  \vspace{-6mm}                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Fragen bzw. Aspekte der Fragen werde ich in meiner Arbeit _nicht_ behandeln? (Eingrenzung des Themas) \vspace{-6mm}                      |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Quellen will ich dazu verwenden? (nur im Überblick, noch keine detaillierte Bibliografie – die gibt es ja noch nicht!)  \vspace{-6mm}  |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Quellen werde ich _nicht_ verwenden? (Eingrenzung des Materials) \vspace{-6mm}                                                           |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Methode will ich anwenden?    \vspace{-6mm}                                                                                            |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Hilfe bzw. Hilfsmittel (Beratung, Infrastruktur, Software, Reisemittel,…) benötige ich für meine Arbeit?  \vspace{-6mm}              |
+----------------------------------------------------------------------------------------------------------------------------------+
|* Wie könnte eine vorläufige Gliederung meiner Arbeit aussehen?  \vspace{-6mm}                                                                   |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Arbeitsschritte, Phasen, Zwischenergebnisse plane ich?  \vspace{-6mm}                                                                  |
+----------------------------------------------------------------------------------------------------------------------------------+
...
|  (sinnvoll als Einleitung, auch wenn Sie annehmen können, dass Ihre Gesprächspartnerin den Inhalt des Exposés kennt)\vspace{-6mm}|           
+----------------------------------------------------------------------------------------------------------------------------------+
|* Welche Schwachpunkte, offenen Fragen, Unklarheiten möchte ich ansprechen? (Sie sind nicht in einer Prüfungssituation:           |
|  Weisen Sie selbst auf Probleme in Ihrem Konzept hin, zu denen Sie Tipps und Ratschläge brauchen)\vspace{-6mm}                   |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Was will ich im Gespräch erreichen? („grünes Licht“, Literaturhinweise, Kontakte, einen weiteren Termin usw.)\vspace{-6mm}     | 
+----------------------------------------------------------------------------------------------------------------------------------+
| * _Während_ des Gesprächs: Welche Hinweise, Anmerkungen und/oder Kritiken zu meinem Konzept haben sich                           | 
| im Laufe des Gesprächs ergeben?\vspace{-6mm}                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche dieser Hinweise, Anmerkungen, Kritiken sind leicht in mein Konzept einzubauen?\vspace{-6mm}                             |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Welche Hinweise, Anmerkungen, Kritiken laufen auf eine komplette Neubearbeitung hinaus?\vspace{-6mm}                           |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Wie lässt sich das gemeinsam erreichte Verständnis zusammenfassen? (Versuchen Sie bereits am Ende des Gesprächs                |
| eine Zusammenfassung zu geben, die das gemeinsam erreichte Verständnis noch einmal absichert.)\vspace{-6mm}                      |
+----------------------------------------------------------------------------------------------------------------------------------+
| * Was sind meine nächsten Arbeitsschritte? (Vereinbaren Sie wenn möglich gleich einen weiteren Gesprächstermin                   |  
| zu einem konkreten Inhalt, z. B. umgearbeitetes Konzept, Literaturliste)\vspace{-6mm}                                            |
+----------------------------------------------------------------------------------------------------------------------------------+
...
Table: **(\#tab:aufgabe1-test) Übungsaufgabe**

+----------------------------------------------------------------------------------------------------------------------------------+
| 1. Suchen Sie ein Thema freier Wahl für eine wissenschaftliche Arbeit.. Finden Sie einen (vorläufigen) Titel für die Arbeit.     |
| \vspace{-6mm}                                                                                                                    |
+----------------------------------------------------------------------------------------------------------------------------------+
| 2. Erschließen Sie das Thema mit einer Methode Ihrer Wahl (freies Schreiben, Assoziieren, Mindmapping ...)\vspace{-6mm}          |
+----------------------------------------------------------------------------------------------------------------------------------+
...
| Ihre Fragestellung(en), warum Sie dieses Thema beschäftigt.\vspace{-6mm}                                                         |
+----------------------------------------------------------------------------------------------------------------------------------+
