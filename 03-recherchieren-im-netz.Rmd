...
* eine komplexe Suchabfrage, mit (Boole’schen) Operatoren verknüpft, siehe Tabelle \@ref(tab:suchmaschinen): oben. 
...
Die Fragen, die Sie bei der Relevanzprüfung an eine Website stellen, sind ganz ähnlich den Fragen bei der Relevanzprüfung von Büchern und Artikeln (siehe Kapitel \@ref(recherchieren): [Recherchieren]). Um einen raschen Überblick zu gewinnen, stehen Ihnen nun aber nicht die üblichen Hilfsmittel wie Klappentext, Inhaltsverzeichnis oder Vorwort zur Verfügung. In einem Hypertext gibt es andere Informationen und Hinweise:
...
### Webseiten auf Qualität prüfen {#webseiten-qualitaet}
...
+----------------------------------------------------------------------------------------------------------------------------------+
| 2. Erweitern Sie die Literatursuche aus dem Kapitel \@ref(recherchieren) um die Recherche im Internet.                           | 
