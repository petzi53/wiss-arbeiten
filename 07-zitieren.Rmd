...
| wenn Sie beim Lesen und Notieren nur kurze, aus dem Kontext gerissene Passagen abgeschrieben haben, aus denen sich der Argumentationsgang nicht mehr rekonstruieren lässt.| analytisch lesen (siehe „Analytisches Lesen“, S. †99 XXX) und beim Lesen und Notieren (Exzerpieren) bereits ans Schreiben und Argumentieren denken. \vspace{-6mm}    |
...
Table: **(\#tab:zitieren) Richtige zitieren**
...
A```{r fig.align='center', echo=FALSE, fig.cap='Grundmuster des Kurzbelegs'}
...
| Wie sieht der Kurzbeleg für ein Werk mehrerer Autoren aus? | Zwei Namen müssen, drei Namen können angeführt werden; ab 3 Namen:  1. Name (wenn eindeutig) und „et al.“ anfügen | (Müüler und Mayer 2003)
(Müller, Mayr & Schmidt 1993:124) bzw. (Müller et al. 1993:124)  \vspace{-6mm}    |
